...
func (i impl) UpdateStatusOrderToItemsHaveArrived(orderID int64, userID int, levelUser int) (dto.JsonResponses, error) {
	...
	err = i.repository.UpdateOrderStatus(orderID, 5, history)
	if err != nil {
		return command.InternalServerResponses("Internal Server Error"), err
	}
